...
echo --- "%ExePath%php.exe" buildExtensionCmd.php -f ../../RSGallery2_J4_Dev\.buildPHP\build_mod_rsg2_slideshow.tsk %OptionFile%
"%ExePath%php.exe" buildExtensionCmd.php -f ../../RSGallery2_J4_Dev\.buildPHP\build_mod_rsg2_slideshow.tsk %OptionFile%
popd
