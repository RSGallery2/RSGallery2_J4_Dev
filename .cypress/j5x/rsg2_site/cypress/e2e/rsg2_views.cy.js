...
//     });
    ...
    it('Enter all views (at once) ', function () {
        ...
        cy.get('a[href="/cypress_5x/?option=com_rsgallery2&view=gallery&id=23&Itemid=357"]').should('have.text', 'RSG2 Slideshow');
        cy.get('a[href="/cypress_5x/?option=com_rsgallery2&view=gallery&id=23&Itemid=357"]').click();

        cy.get('a[href="/cypress_5x/index.php?option=com_rsgallery2&view=slideshow&id=23&Itemid=358"]').should('have.text', 'RSG2 Slideshow');
        cy.get('a[href="/cypress_5x/index.php?option=com_rsgallery2&view=slideshow&id=23&Itemid=358"]').click();
